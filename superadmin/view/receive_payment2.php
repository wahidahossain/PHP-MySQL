                            ...
                            <form role="form" action="model/paynow.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control"
                                           value="<?php $project_sale_id = $_REQUEST['project_sale_id'];
                                           echo $project_sale_id;?>" placeholder="Enter number" type="hidden"
                                           name="project_sale_id">
                                </div>
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    <form action="model/edit_artist.php" method="post">
                        ...
                        <td><?php echo $date;?></td>
                        <td><a href="model/delete_payment.php?payment_id=<?php echo $payment_id;?>&pre_budget_form_step1_id=<?php echo $project_sale_id;?>"
