<div id="page-wrapper">
    <div class="row noprint">
        <div class="col-lg-12">
            <h1 class="page-header">Director wise report</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    <div class="panel panel-default noprint">
        <form action="director_wise_report.php" method="post">
            <div class="panel-heading">

                Search (Director) : <select class="form-control" name="director_entry_id">
                ...
                {
                   $director_entry_id1 = $row['director_entry_id'];
                    $director_entry_name1 = $row['director_entry_name'];
                    $director_detail = $row['director_detail'];
                    ?>
                    <option value="<?php echo $director_entry_id1;?>"><?php echo $director_entry_name1;?></option>
                    <?php } ?>
...
/*
                ...
                //if($project_entry_id!=''){
                $result = mysql_query("SELECT * FROM `pre_budget_form_step1` WHERE `director_entry_id`='$director_entry_id'");
               // }
...
$payment_total = $row_sql7['payment_total'];
                ...
                <tr>
                    ...
                    <td><a href="form_detail.php?pre_budget_form_step1_id=<?php echo $pre_budget_form_step1_id;?>" target="_blank"><?php echo $project_name;?></a></td>
