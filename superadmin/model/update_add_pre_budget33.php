...
$sql1 = "UPDATE `pre_budget_form_step3` SET `director_remunation` = '$director_remunation',
`assistant_director` = '$assistant_director',
`script` = '$script',
`make_up_man_name` = '',
`make_up_man_rate` = '$make_up_man_rate',
`make_up_man_days` = '',
`foods_days` = '$foods_days',
`foods_rate` = '$foods_rate',
`props_days` = '$props_days',
`props_rate` = '$props_rate' WHERE `pre_budget_form_step3`.`pre_budget_form_step1_id` ='$pre_budget_form_step1_id';
";
