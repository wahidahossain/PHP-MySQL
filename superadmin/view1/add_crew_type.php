<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Crew Type Information</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" action="model/add_crew_type.php">
                                <div class="form-group">
                                    <label>Crew Type</label>
                                    <input class="form-control" placeholder="Enter text" name="crew_type" required="required">

                                    <p class="help-block">Give here Crew Type</p>
                                </div>
                                <!--<div class="form-group">
    ...
    <div class="panel-body">
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    <form action="model/edit_crew_type.php" method="post">
                        <td><?php echo $count;?></td>
                        <td><input type="text" value="<?php echo $crew_type;?>" name="crew_type">
                            <input type="hidden" value="<?php echo $crew_entry_id;?>" name="crew_entry_id">
                        </td>
