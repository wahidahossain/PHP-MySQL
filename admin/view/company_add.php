<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Multiple Company Setup</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                        ...
                        <div class="col-lg-6">
                            <form role="form" action="model/add_company.php">
                                <div class="form-group">
                                    ...
                                    <p class="help-block">Give here Company Name</p>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="help-block">Give here Username</p>
                                </div>
                                <div class="form-group">
                                    ...
                                    <p class="help-block">Give here Password</p>
                                </div>
    ...
    <div class="panel-body">
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover">
                ...
                $result = mysql_query("SELECT * FROM `user` WHERE `type`='admin'");
