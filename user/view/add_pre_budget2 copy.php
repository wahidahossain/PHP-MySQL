...
$pre_budget_form_step1_id = $row['pre_budget_form_step1_id'];
    ...
    $date = $row['date'];
                ...
                <tr>
                        ...
                        <td><?php echo $type;?></td>
                        <td><?php echo $date;?></td>
                        <td><a href="add_pre_budget22.php?pre_budget_form_step1_id=<?php echo $pre_budget_form_step1_id;?>"><i class="fa fa-edit fa-fw"></i>Next Step</a>
                           <br> <a href="#" ><i class="fa fa-eraser fa-fw"></i>Delete</a>
