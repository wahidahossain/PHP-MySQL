 ...
 <?php
    ...
    <div class="panel-body">
        <div class="table-responsive">
            <table border="1">
            <tr><td colspan="2" align="center"><h3>Ad Firm Management</h3>
Received & Payment Statement<br>
Date: <?php echo $create_date11;?> to Date: <?php echo $create_date22;?></td></tr>
            <tr><td valign="top">
<h3>Receive</h3>
...
/*
            ...
            //if($project_entry_id!=''){
                                        ...
                                        $result = mysql_query("SELECT * FROM `expenses_entry`  WHERE `id`= '$id' AND `date` BETWEEN '$create_date11' AND '$create_date22'");
