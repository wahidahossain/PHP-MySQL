            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $rate;?></td>
                                            <td>
                                                <a href="model/delete_step4.php?pre_budget_form_step4_id=<?php echo $pre_budget_form_step4_id;?>&pre_budget_form_step1_id=<?php echo $pre_budget_form_step1_id;?>"
                                                   onclick="return confirm('Are you sure you want to delete?')"><i class="fa fa-eraser fa-fw"></i>Delete</a>
